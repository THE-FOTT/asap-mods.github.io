...
let news = [
    ...
    },
    {
        id: 3,
        title: "Online compile",
        desc: "Онлайн компилятор языка <a href=\"https://asap-mods.github.io/compile/c#\" style=\"color: rgb(255, 7, 112); text-decoration: none; font-weight: bold;\">C# <i class=\"style=\"font-size: 12px; color: rgb(255, 7, 112);\"></i></a>",
    },
    {
        id: 4,
        title: "Online compile",
